...
<form method="post">
    ...
    <div class="form-group row">
        <label for="password2" class="col-sm-2 col-form-label">Пароль еще раз</label>
        <div class="col-sm-8">
            <input type="password" class="form-control" id="password2" name="password2" placeholder="Пароль еше раз">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-10">
